                ...
                {latestItems.map((item) => (
                    <div key={item.id} className="rounded-lg border border-telegram-border bg-white/[0.03] p-3">
                        <div className="flex items-start gap-3 text-sm">
                            ...
                            {(item.status === 'pending' || item.status === 'downloading') && onCancelItem && (
                                <button
                            ...
                            {item.status === 'error' && onRetry && (
                                <button
                                    ...
                                    className="rounded-md bg-telegram-primary/15 px-2 py-1 text-[10px] font-medium text-telegram-primary transition hover:bg-telegram-primary/25"
